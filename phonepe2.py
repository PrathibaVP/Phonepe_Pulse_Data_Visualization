...
root_dir = r'C:\Users\prath\OneDrive\Desktop\pulse-master\pulse-master\data'
...
for state_dir in os.listdir(os.path.join(root_dir, r'C:\Users\prath\OneDrive\Desktop\pulse-master\pulse-master\data\aggregated\transaction\country\india\state')):
    state_path = os.path.join(root_dir, r'C:\Users\prath\OneDrive\Desktop\pulse-master\pulse-master\data\aggregated\transaction\country\india\state', state_dir)
...
root_dir = r'C:\Users\prath\OneDrive\Desktop\pulse-master\pulse-master\data\aggregated\user\country\india\state'
df2_list = []
...
# Loop over all the state folders
for state_dir in os.listdir(os.path.join(root_dir, r'C:\Users\prath\OneDrive\Desktop\pulse-master\pulse-master\data\map\transaction\hover\country\india\state')):
    state_path = os.path.join(root_dir, r'C:\Users\prath\OneDrive\Desktop\pulse-master\pulse-master\data\map\transaction\hover\country\india\state', state_dir)
    if os.path.isdir(state_path):
...
root_dir = r'C:\Users\prath\OneDrive\Desktop\pulse-master\pulse-master\data\map\user\hover\country\india\state'
...
# Loop over all the state folders
for state_dir in os.listdir(os.path.join(root_dir, r'C:\Users\prath\OneDrive\Desktop\pulse-master\pulse-master\data\top\transaction\country\india\state')):
    state_path = os.path.join(root_dir, r'C:\Users\prath\OneDrive\Desktop\pulse-master\pulse-master\data\top\transaction\country\india\state', state_dir)
    if os.path.isdir(state_path):
...
root_dir = r'C:\Users\prath\OneDrive\Desktop\pulse-master\pulse-master\data\top\user\country\india\state'
